...
function myFunc7(){
	...
	icon44.style.color = 'black'
	icon55.style.color = 'black'
	icon22.style.transition = " 2s ease"
	...
	icon2.style.transition = " 2s ease"
...
function myFunc8(){
	...
	p5.style.transition = "all 0.7s cubic-bezier(1, -0.17, 0, 4.18)"
	p5.style.color = "#606060"
	icon33.style.transition = " 2s ease"
li2.style.transition = " 2s ease"
icon3.style.transition = " 2s ease"
	li3.style.background = '#e5e5e5'
	li4.style.background = '#e5e5e5'
...
li2.style.transition = " 2s ease"
icon3.style.transition = " 2s ease"
	icon44.style.transition = " 2s ease"
li3.style.transition = " 2s ease"
icon4.style.transition = " 2s ease"
}
...
function myFunc10(){
	...
	icon55.style.transition = " 2s ease"
li4.style.transition = " 2s ease"
icon5.style.transition = " 2s ease"
li1.style.transition = " 2s ease"
icon2.style.transition = " 2s ease"
icon22.style.transition = " 2s ease"
icon33.style.transition = " 2s ease"
